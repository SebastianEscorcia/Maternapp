...
class HistorialEvaluacionesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutScaffold(
      ...
      bottomNav: _buildBotonCompartir(context, provider, materna),
      child: FutureBuilder(
        future: provider.cargarHistorialEvaluaciones(materna!.uid),
              ...
              Align(
                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    await EvaluacionPdfHelper.mostrarDialogoGenerandoPDF(
                        context);
                    try {
  ...
  Widget _buildBotonCompartir(
    ...
    SignosVitalesProvider provider,
    dynamic materna,
  ) {
    return Padding(
